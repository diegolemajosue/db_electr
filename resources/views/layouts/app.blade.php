...
<body>
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm" style="border-bottom: solid 1px red;">
            <div class="container">
                
                @guest
                
                <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/a/a2/LOGO_FAGOR.jpg/640px-LOGO_FAGOR.jpg" width="80" height="30" class="d-inline-block align-top"  alt="">
                @else
...
<div class="col-md-11" style="text-align:center;">
  ...
  <path d="M2 1a2 2 0 0 0-2 2v9.5A1.5 1.5 0 0 0 1.5 14h.653a5.373 5.373 0 0 1 1.066-2H1V3a1 1 0 0 1 1-1h12a1 1 0 0 1 1 1v9h-2.219c.554.654.89 1.373 1.066 2h.653a1.5 1.5 0 0 0 1.5-1.5V3a2 2 0 0 0-2-2H2Z"/>
                            ...
                            <li class="user-footer">
                                <div class="pull-left">
                                    <center>
                                    <a href="http://localhost/db_electro/public/home">Home</a>
                                    </center>
                                </div>

                                <div class="pull-right">
                                    <center>
                                    <a href="http://localhost/db_electro/public/logout" onclick="event.preventDefault();
